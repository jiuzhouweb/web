    ...
    <div class="left_contain">
      <div class='search_contain'>
        <el-form :inline="true" :model="searchList" class="demo-form-inline" size="mini" :rules="rulesSearch" ref='formSearch'>
          ...
          <el-form-item style="margin-bottom:0">
            <div class="importButton2" style="margin-right:0.1rem;margin-bottom:0.1rem" @click="insertReport('formSearch')">生成报表</div>
          </el-form-item>
				</el-form>
      </div>
        ...
        <div class="cardBox" v-loading="loadingCard">
          <div class="eachCard" v-if="showsum">
            ...
            <div class="dataContent topData">
              ...
              <div class="refreshButton" @click="statPerTaxation()">刷新</div>
              <div class="importButton" @click="goImport()">导入</div>
            </div>
          </div>
